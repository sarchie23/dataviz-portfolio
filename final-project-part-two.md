...
Link to Shorthand preview: https://preview.shorthand.com/FMiyqguPXfyhLVYF/responsive/desktop
...
## Interview findings
For the stacked bar chart, the non-basketball fans suggested adding 0 (no transfer) as a category and consolidating the higher categories into 2+. One suggested changing the total transfers from line chart to a bar chart. One suggested adding a line graph showing just the number of 2+ transfers.
...
- Writing the text to craft the story being depicted through the current visuals
- Add annotations to the visuals to call out specific trends
- Harmonizing the formatting/color scheme
- Solicit another round of feedback once I have a full draft with text
